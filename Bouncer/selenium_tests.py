...
if sys.platform == 'linux2':
    ...
    desired_drivers.append(
        "webdriver.Chrome('../selenium_browser_drivers/chromedriver.exe')")
    desired_drivers.append("webdriver.Firefox()")


class current_test_case(unittest.TestCase):

    # unittest will automatically call set_up and then tear_down, these two
    # functions comprise the testing fixture
...
Class pycodestyle_conformance(unittest.TestCase):
